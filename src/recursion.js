...
var alternateSign = function(array) {
  ...
  //set first element to be positive, 
  //push in to arr;
  //next element look at previous element, and set to the opposite
  //how to access the info from element before it?
...
var tagCount = function(tag, node) {
  //use document.getElementByTagName to get array of all elements with the tag in the dom
  //use recursion to count the array.
